<template>
  <div>
    <div id="slogan" class="text-center">
      <h1>NameGator</h1>
      <br/>
      <h6 class="text-secondary">Gerador de nomes utilizando VueJs e NodeJs</h6>
    </div>
    <div id="main">
      <div class="container">
        <div class="row">
          <div class="col-md">
            <h5>Prefixos <span class="badge-info">{{ prefixes.length }}</span></h5>
              <div class="card">
                <div class="card-body">
                  <ul class="list-group">
          ...
          <div class="col-md">
            <h5>Sufixos <span class="badge-info">{{ sufixes.length }}</span></h5>
              <div class="card">
                <div class="card-body">
                  <ul class="list-group">
                    ...
                    {{ sufix }}
                        ...
                        <div class="col-md">
                          <button class="btn btn-info right" v-on:click="deleteSufix(sufix)"><span class="fa fa-trash"></span></button>
                        </div>
                      </div>
                    </li>
                  </ul>
        ...
        <br/>
        <h5>Domínios <span class="badge-info">{{ domains.length }}</span></h5>
        <div class="card">
          <div class="card-body">
            <ul class="list-group">
